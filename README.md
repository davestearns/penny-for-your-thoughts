...
* **Allows equality comparisons:** Regardless of whether the currency is statically or dynamically-typed, you should be able to test two instances for equality since that can never fail.
...
The same approach can be used to support `Sub`, `Mul` and `Div` as well (TODO).
